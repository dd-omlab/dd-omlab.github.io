...
%%% Create QuestFig %%%
%%%%%%%%%%%%%%%%%%%%%%%
tgtFig = gcf; % figure we want dialogbox to be center on.
dummyDlgPos = int32([0 0 0 0]);
dummyDlgPos(3) = 267;
dummyDlgPos(4) =  70;
dlgPos    = centerOnWindow(dummyDlgPos,tgtFig);
...
%set(QuestFig ,'Position',getnicedialoglocation(dlgPos, get(QuestFig,'Units')));
set(QuestFig ,'Position',dlgPos);
